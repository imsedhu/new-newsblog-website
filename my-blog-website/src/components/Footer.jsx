      ...
      <div className='px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4'>
        <div className='grid mb-8 lg:grid-cols-6'>
          ...
          <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
             ...
             <p className='mt-4 text-sm text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam, ipsam. Voluptas ipsa ipsum eligendi dignissimos enim possimus rerum quisquam, neque quidem nam culpa fuga modi quasi reiciendis est eveniet et?</p>
            </div>
        </div>
